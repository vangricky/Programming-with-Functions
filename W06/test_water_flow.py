...
from water_flow import kpa_to_psi_converter
...
def test_pressure_gain_from_water_height():
    assert pressure_gain_from_water_height(0) == approx(0.001, abs=0.001)
...
def test_kpa_to_psi_converter():
    assert kpa_to_psi_converter(158.7) == approx(23.0, abs=0.1)
